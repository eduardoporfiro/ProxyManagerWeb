 ...
 *   <li> soy.renderElement: Render templates and set as innerHTML of an element.
 *   <li> soy.renderAsFragment: Render templates and return as HTML fragment.
 * </ul>
 *
 * <p>
...
if (!goog.soy) goog.soy = {
  /**
   * Helper function to render a Soy templates and then set the
   * output string as the innerHTML of an element. It is recommended
   * to use this helper function instead of directly setting
   * innerHTML in your hand-written code, so that it will be easier
   * to audit the code for cross-site scripting vulnerabilities.
   *
   * @param {Function} template The Soy templates defining element's content.
   * @param {Object=} opt_templateData The data for the templates.
   * @param {Object=} opt_injectedData The injected data for the templates.
  ...
  /**
   * Helper function to render a Soy templates into a single node or
  ...
  /**
   * Helper function to render a Soy templates and then set the output string as
   ...
   * @param {Function} template The Soy templates defining the element's content.
   * @param {Object=} opt_templateData The data for the templates.
   * @param {Object=} opt_injectedData The injected data for the templates.
   */
...
/**
 * Helper function to render a Soy templates into a single node or a document
 ...
 *     element if the templates does not render a single element. If true,
...
soyshim.$$renderWithWrapper_ = function(
  ...
  // If the templates renders as a single element, return it.
 ...
 * you wouldn't write a templates that produces {@code s} on security or privacy
 ...
 * unescaped usage in a Soy templates. A great case is for user-controlled
 ...
 *     and you wouldn't write a templates that produces {@code s} on security or
 ...
 *
 * @param {Element} element The element whose content we are rendering.
 * @param {Function} templates The Soy templates defining the element's content.
 * @param {Object=} opt_templateData The data for the templates.
 * @param {Object=} opt_injectedData The injected data for the templates.
 */
...
/**
 * Helper function to render a Soy templates into a single node. If the rendered
 ...
 *     specified, global document object is used.
 * @param {Object=} opt_injectedData The injected data for the templates.
 * @return {!Element} Rendered templates contents, wrapped in a parent DIV
...
/**
 * Gets a consistent unique id for the given delegate templates name. Two calls
 ...
 * input name.
 *
 * @param {string} delTemplateName The delegate templates name for which to get a
...
/**
 * Map from registered delegate templates key to the priority of the
 * implementation.
 * @type {Object}
 * @private
 */
...
/**
 * Map from registered delegate templates key to the implementation function.
 * @type {Object}
 * @private
 */
...
/**
 * Registers a delegate implementation. If the same delegate templates key (id
 * and variant) has been registered previously, then priority values are
 * compared and only the higher priority implementation is stored (if
 * priorities are equal, an error is thrown).
 *
 * @param {string} delTemplateId The delegate templates id.
 * @param {string} delTemplateVariant The delegate templates variant (can be
 *     empty string).
 ...
 * a given delegate templates key (id and variant). If no implementation has
 * been registered for the key, then the fallback is the same id with empty
 * variant. If the fallback is also not registered, and allowsEmptyDefault is
 * true, then returns an implementation that is equivalent to an empty templates
 * (i.e. rendered output would be empty string).
 *
 * @param {string} delTemplateId The delegate templates id.
 * @param {string} delTemplateVariant The delegate templates variant (can be
 *     empty string).
 * @param {boolean} allowsEmptyDefault Whether to default to the empty templates
...
/**
 * Private helper soy.$$getDelegateFn(). This is the empty templates function
