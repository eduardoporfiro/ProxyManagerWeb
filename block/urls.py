...
urlpatterns = [
    ...
    path('<int:pk>/proxy_delete', views.ViewDeleteProxy.as_view(), name='delete_proxy'),
    path('<int:pk>/mqtt_delete', views.ViewDeleteMqtt.as_view(), name='delete_mqtt'),
    path('<int:pk>/broker_delete', views.ViewDeleteBroker.as_view(), name='delete_broker'),
